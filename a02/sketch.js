...
const strength = 0.2; // "gravitational" force of the vectors on dots ~[0.1 - 10]
const chaosFactor = 2; // the higher, the more inconsistent the vector angles get ~[0.1 - 4]
const particleAmount = 100; // amounts of particles on the canvas ~[100]
